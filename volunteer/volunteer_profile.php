...
$id_volunteer = $_SESSION['id_volunteer'];  // ID du bénévole
$error = '';
$success = '';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['update_email'])) {
        ...
        $stmt->bind_param("si", $new_email, $id_volunteer);
        $stmt->execute();
        ...
        if ($new_password !== $confirm_password) {
            ...
            if (password_verify($current_password, $user['password'])) {
                ...
                $stmt->bind_param("si", $hashed_password, $id_volunteer);
                if ($stmt->execute()) {
...
<body>
    <div class="container">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="volunteer_profile.php" method="POST">
